...
> models::SearchSuggestionsMultiRelationshipDataDocument get_search_suggestion_direct_hits(id, explicit_filter, country_code, include, page_left_square_bracket_cursor_right_square_bracket)
