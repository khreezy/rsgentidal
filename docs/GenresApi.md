...
> models::GenresMultiResourceDataDocument get_genres(page_left_square_bracket_cursor_right_square_bracket, locale, filter_left_square_bracket_id_right_square_bracket)
Get multiple genres.
