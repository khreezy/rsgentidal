...
pub struct StripeConnectionsResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::StripeConnectionsAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::StripeConnectionsRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl StripeConnectionsResourceObject {
    pub fn new(id: String, r#type: String) -> StripeConnectionsResourceObject {
        StripeConnectionsResourceObject {
            attributes: None,
            id,
            relationships: None,
            r#type,
