...
#[serde(default)]
pub struct ReactionsMultiRelationshipDataDocument {
...
impl ReactionsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> ReactionsMultiRelationshipDataDocument {
