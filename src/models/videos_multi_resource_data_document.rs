...
#[serde(default)]
pub struct VideosMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::VideosResourceObject>,
...
impl VideosMultiResourceDataDocument {
    pub fn new(data: Vec<models::VideosResourceObject>, links: models::Links) -> VideosMultiResourceDataDocument {
