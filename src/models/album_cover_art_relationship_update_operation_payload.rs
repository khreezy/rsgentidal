...
pub struct AlbumCoverArtRelationshipUpdateOperationPayload {
    #[serde(rename = "data")]
    pub data: Vec<models::AlbumCoverArtRelationshipUpdateOperationPayloadData>,
}

impl AlbumCoverArtRelationshipUpdateOperationPayload {
    pub fn new(data: Vec<models::AlbumCoverArtRelationshipUpdateOperationPayloadData>) -> AlbumCoverArtRelationshipUpdateOperationPayload {
