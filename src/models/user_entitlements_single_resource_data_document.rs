...
pub struct UserEntitlementsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::UserEntitlementsResourceObject>,
...
impl UserEntitlementsSingleResourceDataDocument {
    pub fn new(data: models::UserEntitlementsResourceObject, links: models::Links) -> UserEntitlementsSingleResourceDataDocument {
        UserEntitlementsSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
