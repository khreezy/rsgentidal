...
pub struct ArtistClaimAcceptedArtistsRelationshipUpdateOperationPayloadData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl ArtistClaimAcceptedArtistsRelationshipUpdateOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> ArtistClaimAcceptedArtistsRelationshipUpdateOperationPayloadData {
        ArtistClaimAcceptedArtistsRelationshipUpdateOperationPayloadData {
            id,
            r#type,
        }
    }
