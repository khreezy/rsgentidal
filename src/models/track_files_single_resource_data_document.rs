...
#[serde(default)]
pub struct TrackFilesSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::TrackFilesResourceObject>,
...
impl TrackFilesSingleResourceDataDocument {
    pub fn new(data: models::TrackFilesResourceObject, links: models::Links) -> TrackFilesSingleResourceDataDocument {
        TrackFilesSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
