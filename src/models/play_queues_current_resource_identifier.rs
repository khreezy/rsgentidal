...
#[serde(default)]
pub struct PlayQueuesCurrentResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::PlayQueuesCurrentResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl PlayQueuesCurrentResourceIdentifier {
    pub fn new(id: String, r#type: String) -> PlayQueuesCurrentResourceIdentifier {
