...
#[serde(default)]
pub struct ArtistClaimsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::ArtistClaimsResourceObject>,
...
impl ArtistClaimsSingleResourceDataDocument {
    pub fn new(data: models::ArtistClaimsResourceObject, links: models::Links) -> ArtistClaimsSingleResourceDataDocument {
        ArtistClaimsSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
