...
pub struct ReactedResourceRelationship {
    #[serde(rename = "data")]
    pub data: Box<models::ReactedResourceIdentifier>,
}

impl ReactedResourceRelationship {
    pub fn new(data: models::ReactedResourceIdentifier) -> ReactedResourceRelationship {
