...
#[serde(default)]
pub struct TrackUpdateOperationPayloadDataRelationshipsGenresData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl TrackUpdateOperationPayloadDataRelationshipsGenresData {
    pub fn new(id: String, r#type: Type) -> TrackUpdateOperationPayloadDataRelationshipsGenresData {
        TrackUpdateOperationPayloadDataRelationshipsGenresData { id, r#type }
    }
}
///
