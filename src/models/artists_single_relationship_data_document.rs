...
pub struct ArtistsSingleRelationshipDataDocument {
...
impl ArtistsSingleRelationshipDataDocument {
    pub fn new(links: models::Links) -> ArtistsSingleRelationshipDataDocument {
        ArtistsSingleRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
