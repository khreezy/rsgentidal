...
pub struct ArtistClaimsCreateOperationPayloadData {
    ...
    pub attributes: Box<models::ArtistClaimsCreateOperationPayloadDataAttributes>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl ArtistClaimsCreateOperationPayloadData {
    pub fn new(attributes: models::ArtistClaimsCreateOperationPayloadDataAttributes, r#type: Type) -> ArtistClaimsCreateOperationPayloadData {
