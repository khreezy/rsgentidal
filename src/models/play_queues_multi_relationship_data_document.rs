...
#[serde(default)]
pub struct PlayQueuesMultiRelationshipDataDocument {
...
impl PlayQueuesMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> PlayQueuesMultiRelationshipDataDocument {
