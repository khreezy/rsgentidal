...
#[serde(default)]
pub struct PlayQueueCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::PlayQueueCreateOperationPayloadData>,
}

impl PlayQueueCreateOperationPayload {
    pub fn new(data: models::PlayQueueCreateOperationPayloadData) -> PlayQueueCreateOperationPayload {
