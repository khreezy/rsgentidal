...
#[serde(default)]
pub struct AlbumsItemsMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::AlbumsItemsResourceIdentifier>>,
...
impl AlbumsItemsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> AlbumsItemsMultiRelationshipDataDocument {
