...
pub struct FolderUpdateOperationPayloadData {
...
impl FolderUpdateOperationPayloadData {
    pub fn new(attributes: models::Attributes, id: String, r#type: Type) -> FolderUpdateOperationPayloadData {
