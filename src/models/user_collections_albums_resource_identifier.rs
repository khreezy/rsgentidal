...
#[serde(default)]
pub struct UserCollectionsAlbumsResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::UserCollectionsAlbumsResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl UserCollectionsAlbumsResourceIdentifier {
    pub fn new(id: String, r#type: String) -> UserCollectionsAlbumsResourceIdentifier {
        UserCollectionsAlbumsResourceIdentifier {
            id,
            meta: None,
            r#type,
        }
