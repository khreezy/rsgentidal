...
#[serde(default)]
pub struct UserCollectionAlbumsRelationshipAddOperationPayloadDataMeta {
    #[serde(rename = "addedAt", skip_serializing_if = "Option::is_none")]
    pub added_at: Option<String>,
}

impl UserCollectionAlbumsRelationshipAddOperationPayloadDataMeta {
    pub fn new() -> UserCollectionAlbumsRelationshipAddOperationPayloadDataMeta {
