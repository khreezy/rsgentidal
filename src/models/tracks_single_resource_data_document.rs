...
pub struct TracksSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::TracksResourceObject>,
...
impl TracksSingleResourceDataDocument {
    pub fn new(data: models::TracksResourceObject, links: models::Links) -> TracksSingleResourceDataDocument {
