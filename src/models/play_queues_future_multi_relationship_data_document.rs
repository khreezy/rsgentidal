...
pub struct PlayQueuesFutureMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::PlayQueuesFutureResourceIdentifier>>,
...
impl PlayQueuesFutureMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> PlayQueuesFutureMultiRelationshipDataDocument {
