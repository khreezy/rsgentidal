...
pub struct DynamicPagesResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::DynamicPagesAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::DynamicPagesRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl DynamicPagesResourceObject {
    pub fn new(id: String, r#type: String) -> DynamicPagesResourceObject {
