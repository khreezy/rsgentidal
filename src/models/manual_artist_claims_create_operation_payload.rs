...
pub struct ManualArtistClaimsCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::ManualArtistClaimsCreateOperationPayloadData>,
}

impl ManualArtistClaimsCreateOperationPayload {
    pub fn new(data: models::ManualArtistClaimsCreateOperationPayloadData) -> ManualArtistClaimsCreateOperationPayload {
