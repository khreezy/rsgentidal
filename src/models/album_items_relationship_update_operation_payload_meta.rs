...
#[serde(default)]
pub struct AlbumItemsRelationshipUpdateOperationPayloadMeta {
    /// 1-based index
    #[serde(rename = "positionIndex")]
    pub position_index: i32,
}

impl AlbumItemsRelationshipUpdateOperationPayloadMeta {
    pub fn new(position_index: i32) -> AlbumItemsRelationshipUpdateOperationPayloadMeta {
        AlbumItemsRelationshipUpdateOperationPayloadMeta {
            position_index,
        }
    }
}
