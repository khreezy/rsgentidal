...
pub struct TrackCreateOperationPayloadDataRelationshipsArtistsData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl TrackCreateOperationPayloadDataRelationshipsArtistsData {
    pub fn new(id: String, r#type: Type) -> TrackCreateOperationPayloadDataRelationshipsArtistsData {
        TrackCreateOperationPayloadDataRelationshipsArtistsData {
            id,
            r#type,
        }
    }
