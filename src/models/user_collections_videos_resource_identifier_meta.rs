...
#[serde(default)]
pub struct UserCollectionsVideosResourceIdentifierMeta {
    #[serde(rename = "addedAt")]
    pub added_at: String,
}

impl UserCollectionsVideosResourceIdentifierMeta {
    pub fn new(added_at: String) -> UserCollectionsVideosResourceIdentifierMeta {
        UserCollectionsVideosResourceIdentifierMeta {
            added_at,
        }
    }
}
