...
#[serde(default)]
pub struct Default406ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::Default406ResponseBodyErrorsInner>,
}

impl Default406ResponseBody {
    pub fn new(errors: Vec<models::Default406ResponseBodyErrorsInner>) -> Default406ResponseBody {
