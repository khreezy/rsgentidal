...
pub struct PlaylistItemsRelationshipAddOperationPayloadDataMeta {
    #[serde(rename = "addedAt", skip_serializing_if = "Option::is_none")]
    pub added_at: Option<String>,
}

impl PlaylistItemsRelationshipAddOperationPayloadDataMeta {
    pub fn new() -> PlaylistItemsRelationshipAddOperationPayloadDataMeta {
