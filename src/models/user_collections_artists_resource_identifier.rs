...
#[serde(default)]
pub struct UserCollectionsArtistsResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::UserCollectionsArtistsResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl UserCollectionsArtistsResourceIdentifier {
    pub fn new(id: String, r#type: String) -> UserCollectionsArtistsResourceIdentifier {
        UserCollectionsArtistsResourceIdentifier {
            id,
            meta: None,
            r#type,
        }
