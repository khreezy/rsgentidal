...
pub struct UserCollectionAlbumsRelationshipAddOperationPayloadData {
    ...
    pub meta: Option<Box<models::UserCollectionAlbumsRelationshipAddOperationPayloadDataMeta>>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl UserCollectionAlbumsRelationshipAddOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> UserCollectionAlbumsRelationshipAddOperationPayloadData {
