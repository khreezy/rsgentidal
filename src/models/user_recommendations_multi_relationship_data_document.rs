...
#[serde(default)]
pub struct UserRecommendationsMultiRelationshipDataDocument {
...
impl UserRecommendationsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> UserRecommendationsMultiRelationshipDataDocument {
        UserRecommendationsMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
