...
#[serde(default)]
pub struct TracksMultiRelationshipDataDocument {
...
impl TracksMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> TracksMultiRelationshipDataDocument {
        TracksMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
