...
pub struct TracksSingleRelationshipDataDocument {
...
impl TracksSingleRelationshipDataDocument {
    pub fn new(links: models::Links) -> TracksSingleRelationshipDataDocument {
        TracksSingleRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
