...
#[serde(default)]
pub struct FolderUpdateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::FolderUpdateOperationPayloadData>,
}

impl FolderUpdateOperationPayload {
    pub fn new(data: models::FolderUpdateOperationPayloadData) -> FolderUpdateOperationPayload {
