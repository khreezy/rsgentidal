...
#[serde(default)]
pub struct ArtistsMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::ArtistsResourceObject>,
...
impl ArtistsMultiResourceDataDocument {
    pub fn new(data: Vec<models::ArtistsResourceObject>, links: models::Links) -> ArtistsMultiResourceDataDocument {
        ArtistsMultiResourceDataDocument {
            data,
            included: None,
            links: Box::new(links),
        }
