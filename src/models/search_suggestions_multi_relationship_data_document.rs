...
#[serde(default)]
pub struct SearchSuggestionsMultiRelationshipDataDocument {
...
impl SearchSuggestionsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> SearchSuggestionsMultiRelationshipDataDocument {
        SearchSuggestionsMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
