...
#[serde(default)]
pub struct TrackUpdateOperationPayloadDataRelationships {
    #[serde(rename = "genres", skip_serializing_if = "Option::is_none")]
    pub genres: Option<Box<models::TrackUpdateOperationPayloadDataRelationshipsGenres>>,
}

impl TrackUpdateOperationPayloadDataRelationships {
    pub fn new() -> TrackUpdateOperationPayloadDataRelationships {
        TrackUpdateOperationPayloadDataRelationships { genres: None }
    }
}
