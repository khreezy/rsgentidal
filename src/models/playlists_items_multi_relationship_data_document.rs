...
#[serde(default)]
pub struct PlaylistsItemsMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::PlaylistsItemsResourceIdentifier>>,
...
impl PlaylistsItemsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> PlaylistsItemsMultiRelationshipDataDocument {
