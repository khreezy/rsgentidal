...
pub struct UserCollectionFoldersMultiRelationshipDataDocument {
...
impl UserCollectionFoldersMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> UserCollectionFoldersMultiRelationshipDataDocument {
