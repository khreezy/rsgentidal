...
pub struct Default415ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::Default415ResponseBodyErrorsInner>,
}

impl Default415ResponseBody {
    pub fn new(errors: Vec<models::Default415ResponseBodyErrorsInner>) -> Default415ResponseBody {
