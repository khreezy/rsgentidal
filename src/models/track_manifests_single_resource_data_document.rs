...
pub struct TrackManifestsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::TrackManifestsResourceObject>,
...
impl TrackManifestsSingleResourceDataDocument {
    pub fn new(data: models::TrackManifestsResourceObject, links: models::Links) -> TrackManifestsSingleResourceDataDocument {
