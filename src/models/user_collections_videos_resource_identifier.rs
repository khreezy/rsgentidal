...
pub struct UserCollectionsVideosResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::UserCollectionsVideosResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl UserCollectionsVideosResourceIdentifier {
    pub fn new(id: String, r#type: String) -> UserCollectionsVideosResourceIdentifier {
        UserCollectionsVideosResourceIdentifier {
            id,
            meta: None,
            r#type,
        }
