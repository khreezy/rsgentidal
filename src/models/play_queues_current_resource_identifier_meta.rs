...
#[serde(default)]
pub struct PlayQueuesCurrentResourceIdentifierMeta {
...
impl PlayQueuesCurrentResourceIdentifierMeta {
    pub fn new(batch_id: uuid::Uuid, item_id: String) -> PlayQueuesCurrentResourceIdentifierMeta {
