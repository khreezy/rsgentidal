...
pub struct ArtistsFollowersResourceIdentifierMeta {
...
impl ArtistsFollowersResourceIdentifierMeta {
    pub fn new() -> ArtistsFollowersResourceIdentifierMeta {
        ArtistsFollowersResourceIdentifierMeta {
            viewer: None,
        }
    }
}
