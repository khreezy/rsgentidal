...
pub struct PlaylistItemsRelationshipAddOperationPayloadData {
    ...
    pub meta: Option<Box<models::PlaylistItemsRelationshipAddOperationPayloadDataMeta>>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl PlaylistItemsRelationshipAddOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> PlaylistItemsRelationshipAddOperationPayloadData {
