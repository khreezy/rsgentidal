...
#[serde(default)]
pub struct UsersMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::UsersResourceObject>,
...
impl UsersMultiResourceDataDocument {
    pub fn new(data: Vec<models::UsersResourceObject>, links: models::Links) -> UsersMultiResourceDataDocument {
