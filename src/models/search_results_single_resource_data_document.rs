...
pub struct SearchResultsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::SearchResultsResourceObject>,
...
impl SearchResultsSingleResourceDataDocument {
    pub fn new(data: models::SearchResultsResourceObject, links: models::Links) -> SearchResultsSingleResourceDataDocument {
        SearchResultsSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
