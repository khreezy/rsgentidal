...
#[serde(default)]
pub struct SearchSuggestionsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::SearchSuggestionsResourceObject>,
...
impl SearchSuggestionsSingleResourceDataDocument {
    pub fn new(data: models::SearchSuggestionsResourceObject, links: models::Links) -> SearchSuggestionsSingleResourceDataDocument {
        SearchSuggestionsSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
