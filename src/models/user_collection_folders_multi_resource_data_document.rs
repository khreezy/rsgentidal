...
#[serde(default)]
pub struct UserCollectionFoldersMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::UserCollectionFoldersResourceObject>,
...
impl UserCollectionFoldersMultiResourceDataDocument {
    pub fn new(data: Vec<models::UserCollectionFoldersResourceObject>, links: models::Links) -> UserCollectionFoldersMultiResourceDataDocument {
