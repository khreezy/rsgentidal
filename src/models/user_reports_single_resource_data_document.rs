...
pub struct UserReportsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::UserReportsResourceObject>,
...
impl UserReportsSingleResourceDataDocument {
    pub fn new(data: models::UserReportsResourceObject, links: models::Links) -> UserReportsSingleResourceDataDocument {
        UserReportsSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
