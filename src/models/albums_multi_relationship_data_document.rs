...
pub struct AlbumsMultiRelationshipDataDocument {
...
impl AlbumsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> AlbumsMultiRelationshipDataDocument {
        AlbumsMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
