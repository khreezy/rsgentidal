...
pub struct TrackFilesReadById403ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::TrackFilesReadById403ResponseBodyErrorsInner>,
}

impl TrackFilesReadById403ResponseBody {
    pub fn new(errors: Vec<models::TrackFilesReadById403ResponseBodyErrorsInner>) -> TrackFilesReadById403ResponseBody {
