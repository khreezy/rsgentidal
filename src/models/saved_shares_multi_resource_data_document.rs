...
pub struct SavedSharesMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::SavedSharesResourceObject>,
...
impl SavedSharesMultiResourceDataDocument {
    pub fn new(data: Vec<models::SavedSharesResourceObject>, links: models::Links) -> SavedSharesMultiResourceDataDocument {
