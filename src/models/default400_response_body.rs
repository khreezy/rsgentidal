...
pub struct Default400ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::Default400ResponseBodyErrorsInner>,
}

impl Default400ResponseBody {
    pub fn new(errors: Vec<models::Default400ResponseBodyErrorsInner>) -> Default400ResponseBody {
