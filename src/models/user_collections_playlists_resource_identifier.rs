...
pub struct UserCollectionsPlaylistsResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::UserCollectionsPlaylistsResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl UserCollectionsPlaylistsResourceIdentifier {
    pub fn new(id: String, r#type: String) -> UserCollectionsPlaylistsResourceIdentifier {
        UserCollectionsPlaylistsResourceIdentifier {
            id,
            meta: None,
            r#type,
        }
