...
#[serde(default)]
pub struct UserCollectionsMultiRelationshipDataDocument {
...
impl UserCollectionsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> UserCollectionsMultiRelationshipDataDocument {
        UserCollectionsMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
