...
#[serde(default)]
pub struct UserCollectionsTracksResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::UserCollectionsTracksResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl UserCollectionsTracksResourceIdentifier {
    pub fn new(id: String, r#type: String) -> UserCollectionsTracksResourceIdentifier {
