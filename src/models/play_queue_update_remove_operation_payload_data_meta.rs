...
pub struct PlayQueueUpdateRemoveOperationPayloadDataMeta {
    #[serde(rename = "itemId")]
    pub item_id: String,
}

impl PlayQueueUpdateRemoveOperationPayloadDataMeta {
    pub fn new(item_id: String) -> PlayQueueUpdateRemoveOperationPayloadDataMeta {
