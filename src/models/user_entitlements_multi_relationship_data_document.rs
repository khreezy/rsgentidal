...
pub struct UserEntitlementsMultiRelationshipDataDocument {
...
impl UserEntitlementsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> UserEntitlementsMultiRelationshipDataDocument {
