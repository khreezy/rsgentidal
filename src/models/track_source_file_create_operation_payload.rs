...
pub struct TrackSourceFileCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::TrackSourceFileCreateOperationPayloadData>,
}

impl TrackSourceFileCreateOperationPayload {
    pub fn new(data: models::TrackSourceFileCreateOperationPayloadData) -> TrackSourceFileCreateOperationPayload {
        TrackSourceFileCreateOperationPayload {
            data: Box::new(data),
        }
    }
}
