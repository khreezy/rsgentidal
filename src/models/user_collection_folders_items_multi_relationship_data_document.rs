...
pub struct UserCollectionFoldersItemsMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::UserCollectionFoldersItemsResourceIdentifier>>,
...
impl UserCollectionFoldersItemsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> UserCollectionFoldersItemsMultiRelationshipDataDocument {
