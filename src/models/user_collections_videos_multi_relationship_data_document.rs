...
pub struct UserCollectionsVideosMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::UserCollectionsVideosResourceIdentifier>>,
...
impl UserCollectionsVideosMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> UserCollectionsVideosMultiRelationshipDataDocument {
