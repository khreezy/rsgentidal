...
#[serde(default)]
pub struct PlaylistItemsRelationshipRemoveOperationPayload {
    #[serde(rename = "data")]
    pub data: Vec<models::PlaylistItemsRelationshipRemoveOperationPayloadData>,
}

impl PlaylistItemsRelationshipRemoveOperationPayload {
    pub fn new(data: Vec<models::PlaylistItemsRelationshipRemoveOperationPayloadData>) -> PlaylistItemsRelationshipRemoveOperationPayload {
