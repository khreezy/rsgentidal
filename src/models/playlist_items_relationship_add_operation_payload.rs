...
pub struct PlaylistItemsRelationshipAddOperationPayload {
    ...
    pub meta: Option<Box<models::PlaylistItemsRelationshipAddOperationPayloadMeta>>,
}

impl PlaylistItemsRelationshipAddOperationPayload {
    pub fn new(data: Vec<models::PlaylistItemsRelationshipAddOperationPayloadData>) -> PlaylistItemsRelationshipAddOperationPayload {
