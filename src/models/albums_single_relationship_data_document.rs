...
#[serde(default)]
pub struct AlbumsSingleRelationshipDataDocument {
...
impl AlbumsSingleRelationshipDataDocument {
    pub fn new(links: models::Links) -> AlbumsSingleRelationshipDataDocument {
