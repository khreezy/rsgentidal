...
#[serde(default)]
pub struct TrackCreateOperationPayloadDataRelationshipsAlbumsData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl TrackCreateOperationPayloadDataRelationshipsAlbumsData {
    pub fn new(id: String, r#type: Type) -> TrackCreateOperationPayloadDataRelationshipsAlbumsData {
        TrackCreateOperationPayloadDataRelationshipsAlbumsData {
            id,
            r#type,
        }
    }
