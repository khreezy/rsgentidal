...
#[serde(default)]
pub struct UserCollectionTracksRelationshipRemoveOperationPayload {
    #[serde(rename = "data")]
    pub data: Vec<models::UserCollectionTracksRelationshipRemoveOperationPayloadData>,
}

impl UserCollectionTracksRelationshipRemoveOperationPayload {
    pub fn new(data: Vec<models::UserCollectionTracksRelationshipRemoveOperationPayloadData>) -> UserCollectionTracksRelationshipRemoveOperationPayload {
