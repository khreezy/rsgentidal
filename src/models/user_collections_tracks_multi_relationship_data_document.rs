...
pub struct UserCollectionsTracksMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::UserCollectionsTracksResourceIdentifier>>,
...
impl UserCollectionsTracksMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> UserCollectionsTracksMultiRelationshipDataDocument {
