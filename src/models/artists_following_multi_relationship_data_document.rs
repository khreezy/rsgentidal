...
pub struct ArtistsFollowingMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::ArtistsFollowingResourceIdentifier>>,
...
impl ArtistsFollowingMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> ArtistsFollowingMultiRelationshipDataDocument {
        ArtistsFollowingMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
