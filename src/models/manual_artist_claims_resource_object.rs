...
pub struct ManualArtistClaimsResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::ManualArtistClaimsAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    /// Resource type
...
impl ManualArtistClaimsResourceObject {
    pub fn new(id: String, r#type: String) -> ManualArtistClaimsResourceObject {
