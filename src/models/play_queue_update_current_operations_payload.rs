...
pub struct PlayQueueUpdateCurrentOperationsPayload {
    #[serde(rename = "data")]
    pub data: Box<models::PlayQueueUpdateCurrentOperationsPayloadData>,
}

impl PlayQueueUpdateCurrentOperationsPayload {
    pub fn new(data: models::PlayQueueUpdateCurrentOperationsPayloadData) -> PlayQueueUpdateCurrentOperationsPayload {
