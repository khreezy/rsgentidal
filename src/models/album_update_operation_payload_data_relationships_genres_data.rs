...
#[serde(default)]
pub struct AlbumUpdateOperationPayloadDataRelationshipsGenresData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl AlbumUpdateOperationPayloadDataRelationshipsGenresData {
    pub fn new(id: String, r#type: Type) -> AlbumUpdateOperationPayloadDataRelationshipsGenresData {
        AlbumUpdateOperationPayloadDataRelationshipsGenresData {
            id,
            r#type,
        }
    }
