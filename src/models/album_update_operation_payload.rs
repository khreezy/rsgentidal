...
#[serde(default)]
pub struct AlbumUpdateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::AlbumUpdateOperationPayloadData>,
}

impl AlbumUpdateOperationPayload {
    pub fn new(data: models::AlbumUpdateOperationPayloadData) -> AlbumUpdateOperationPayload {
        AlbumUpdateOperationPayload {
            data: Box::new(data),
        }
    }
}
