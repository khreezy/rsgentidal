...
#[serde(default)]
pub struct SingleRelationshipDataDocument {
...
impl SingleRelationshipDataDocument {
    pub fn new(links: models::Links) -> SingleRelationshipDataDocument {
        SingleRelationshipDataDocument {
            data: None,
            links: Box::new(links),
        }
    }
