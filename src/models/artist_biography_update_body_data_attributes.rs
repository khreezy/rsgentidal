...
pub struct ArtistBiographyUpdateBodyDataAttributes {
    #[serde(rename = "text", skip_serializing_if = "Option::is_none")]
    pub text: Option<String>,
}

impl ArtistBiographyUpdateBodyDataAttributes {
    pub fn new() -> ArtistBiographyUpdateBodyDataAttributes {
        ArtistBiographyUpdateBodyDataAttributes {
            text: None,
        }
    }
}
