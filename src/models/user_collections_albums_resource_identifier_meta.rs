...
#[serde(default)]
pub struct UserCollectionsAlbumsResourceIdentifierMeta {
    #[serde(rename = "addedAt")]
    pub added_at: String,
}

impl UserCollectionsAlbumsResourceIdentifierMeta {
    pub fn new(added_at: String) -> UserCollectionsAlbumsResourceIdentifierMeta {
        UserCollectionsAlbumsResourceIdentifierMeta {
            added_at,
        }
    }
}
