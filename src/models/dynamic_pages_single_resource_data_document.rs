...
pub struct DynamicPagesSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::DynamicPagesResourceObject>,
...
impl DynamicPagesSingleResourceDataDocument {
    pub fn new(data: models::DynamicPagesResourceObject, links: models::Links) -> DynamicPagesSingleResourceDataDocument {
