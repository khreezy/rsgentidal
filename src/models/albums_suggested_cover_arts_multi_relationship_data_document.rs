...
pub struct AlbumsSuggestedCoverArtsMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::AlbumsSuggestedCoverArtsResourceIdentifier>>,
...
impl AlbumsSuggestedCoverArtsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> AlbumsSuggestedCoverArtsMultiRelationshipDataDocument {
