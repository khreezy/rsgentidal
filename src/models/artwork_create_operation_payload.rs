...
pub struct ArtworkCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::ArtworkCreateOperationPayloadData>,
}

impl ArtworkCreateOperationPayload {
    pub fn new(data: models::ArtworkCreateOperationPayloadData) -> ArtworkCreateOperationPayload {
        ArtworkCreateOperationPayload {
            data: Box::new(data),
        }
    }
}
