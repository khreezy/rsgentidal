...
pub struct Default503ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::Default503ResponseBodyErrorsInner>,
}

impl Default503ResponseBody {
    pub fn new(errors: Vec<models::Default503ResponseBodyErrorsInner>) -> Default503ResponseBody {
