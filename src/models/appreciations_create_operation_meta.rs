...
#[serde(default)]
pub struct AppreciationsCreateOperationMeta {
    #[serde(rename = "dryRun", skip_serializing_if = "Option::is_none")]
    pub dry_run: Option<bool>,
}

impl AppreciationsCreateOperationMeta {
    pub fn new() -> AppreciationsCreateOperationMeta {
        AppreciationsCreateOperationMeta {
            dry_run: None,
        }
    }
}
