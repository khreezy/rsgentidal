...
pub struct StripeConnectionsRelationships {
    #[serde(rename = "owners")]
    pub owners: Box<models::MultiRelationshipDataDocument>,
}

impl StripeConnectionsRelationships {
    pub fn new(owners: models::MultiRelationshipDataDocument) -> StripeConnectionsRelationships {
