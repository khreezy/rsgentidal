...
pub struct SavedSharesSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::SavedSharesResourceObject>,
...
impl SavedSharesSingleResourceDataDocument {
    pub fn new(data: models::SavedSharesResourceObject, links: models::Links) -> SavedSharesSingleResourceDataDocument {
