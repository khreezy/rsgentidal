...
#[serde(default)]
pub struct PlayQueueUpdateCurrentOperationsPayloadDataMeta {
    #[serde(rename = "itemId")]
    pub item_id: String,
}

impl PlayQueueUpdateCurrentOperationsPayloadDataMeta {
    pub fn new(item_id: String) -> PlayQueueUpdateCurrentOperationsPayloadDataMeta {
