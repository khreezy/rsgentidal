...
pub struct TrackFilesReadById404ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::TrackFilesReadById404ResponseBodyErrorsInner>,
}

impl TrackFilesReadById404ResponseBody {
    pub fn new(errors: Vec<models::TrackFilesReadById404ResponseBodyErrorsInner>) -> TrackFilesReadById404ResponseBody {
