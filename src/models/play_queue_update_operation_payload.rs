...
#[serde(default)]
pub struct PlayQueueUpdateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::PlayQueueUpdateOperationPayloadData>,
}

impl PlayQueueUpdateOperationPayload {
    pub fn new(data: models::PlayQueueUpdateOperationPayloadData) -> PlayQueueUpdateOperationPayload {
