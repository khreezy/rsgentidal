...
#[serde(default)]
pub struct UserReportCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::UserReportCreateOperationPayloadData>,
}

impl UserReportCreateOperationPayload {
    pub fn new(data: models::UserReportCreateOperationPayloadData) -> UserReportCreateOperationPayload {
        UserReportCreateOperationPayload {
            data: Box::new(data),
        }
    }
}
