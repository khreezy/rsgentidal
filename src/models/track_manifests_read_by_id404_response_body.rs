...
#[serde(default)]
pub struct TrackManifestsReadById404ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::TrackFilesReadById404ResponseBodyErrorsInner>,
}

impl TrackManifestsReadById404ResponseBody {
    pub fn new(errors: Vec<models::TrackFilesReadById404ResponseBodyErrorsInner>) -> TrackManifestsReadById404ResponseBody {
