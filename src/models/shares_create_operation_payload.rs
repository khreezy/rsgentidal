...
#[serde(default)]
pub struct SharesCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::SharesCreateOperationPayloadData>,
}

impl SharesCreateOperationPayload {
    pub fn new(data: models::SharesCreateOperationPayloadData) -> SharesCreateOperationPayload {
