...
#[serde(default)]
pub struct ProvidersMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::ProvidersResourceObject>,
...
impl ProvidersMultiResourceDataDocument {
    pub fn new(data: Vec<models::ProvidersResourceObject>, links: models::Links) -> ProvidersMultiResourceDataDocument {
        ProvidersMultiResourceDataDocument {
            data,
            included: None,
            links: Box::new(links),
        }
