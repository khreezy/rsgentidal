...
pub struct AlbumItemsRelationshipUpdateOperationPayloadData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl AlbumItemsRelationshipUpdateOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> AlbumItemsRelationshipUpdateOperationPayloadData {
