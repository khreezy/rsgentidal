...
pub struct PlaylistItemsRelationshipReorderOperationPayloadData {
    ...
    pub id: String,
    #[serde(rename = "meta")]
    pub meta: Box<models::PlaylistItemsRelationshipReorderOperationPayloadDataMeta>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl PlaylistItemsRelationshipReorderOperationPayloadData {
    pub fn new(id: String, meta: models::PlaylistItemsRelationshipReorderOperationPayloadDataMeta, r#type: Type) -> PlaylistItemsRelationshipReorderOperationPayloadData {
