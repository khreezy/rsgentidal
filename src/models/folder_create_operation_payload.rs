...
#[serde(default)]
pub struct FolderCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::FolderCreateOperationPayloadData>,
}

impl FolderCreateOperationPayload {
    pub fn new(data: models::FolderCreateOperationPayloadData) -> FolderCreateOperationPayload {
