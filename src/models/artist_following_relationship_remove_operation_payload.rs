...
#[serde(default)]
pub struct ArtistFollowingRelationshipRemoveOperationPayload {
    #[serde(rename = "data")]
    pub data: Vec<models::ArtistFollowingRelationshipRemoveOperationPayloadData>,
}

impl ArtistFollowingRelationshipRemoveOperationPayload {
    pub fn new(data: Vec<models::ArtistFollowingRelationshipRemoveOperationPayloadData>) -> ArtistFollowingRelationshipRemoveOperationPayload {
