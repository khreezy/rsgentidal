...
#[serde(default)]
pub struct Default500ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::Default500ResponseBodyErrorsInner>,
}

impl Default500ResponseBody {
    pub fn new(errors: Vec<models::Default500ResponseBodyErrorsInner>) -> Default500ResponseBody {
