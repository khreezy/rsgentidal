...
pub struct ArtistsFollowersMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::ArtistsFollowersResourceIdentifier>>,
...
impl ArtistsFollowersMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> ArtistsFollowersMultiRelationshipDataDocument {
