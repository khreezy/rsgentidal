...
#[serde(default)]
pub struct DynamicPagesSingleRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ResourceIdentifier>>,
...
impl DynamicPagesSingleRelationshipDataDocument {
    pub fn new(links: models::Links) -> DynamicPagesSingleRelationshipDataDocument {
