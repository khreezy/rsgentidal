...
pub struct PlayQueuesPastMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::PlayQueuesPastResourceIdentifier>>,
...
impl PlayQueuesPastMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> PlayQueuesPastMultiRelationshipDataDocument {
