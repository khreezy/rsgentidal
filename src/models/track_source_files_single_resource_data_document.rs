...
pub struct TrackSourceFilesSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::TrackSourceFilesResourceObject>,
...
impl TrackSourceFilesSingleResourceDataDocument {
    pub fn new(data: models::TrackSourceFilesResourceObject, links: models::Links) -> TrackSourceFilesSingleResourceDataDocument {
        TrackSourceFilesSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
