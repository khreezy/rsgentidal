...
#[serde(default)]
pub struct ArtistsTrackProvidersMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::ArtistsTrackProvidersResourceIdentifier>>,
...
impl ArtistsTrackProvidersMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> ArtistsTrackProvidersMultiRelationshipDataDocument {
