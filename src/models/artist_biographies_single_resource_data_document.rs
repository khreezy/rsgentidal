...
#[serde(default)]
pub struct ArtistBiographiesSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::ArtistBiographiesResourceObject>,
...
impl ArtistBiographiesSingleResourceDataDocument {
    pub fn new(data: models::ArtistBiographiesResourceObject, links: models::Links) -> ArtistBiographiesSingleResourceDataDocument {
        ArtistBiographiesSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
