...
#[serde(default)]
pub struct ManualArtistClaimsMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::ManualArtistClaimsResourceObject>,
...
impl ManualArtistClaimsMultiResourceDataDocument {
    pub fn new(data: Vec<models::ManualArtistClaimsResourceObject>, links: models::Links) -> ManualArtistClaimsMultiResourceDataDocument {
