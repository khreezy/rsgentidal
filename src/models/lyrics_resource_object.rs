...
pub struct LyricsResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::LyricsAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::LyricsRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl LyricsResourceObject {
    pub fn new(id: String, r#type: String) -> LyricsResourceObject {
