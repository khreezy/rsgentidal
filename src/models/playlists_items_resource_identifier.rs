...
#[serde(default)]
pub struct PlaylistsItemsResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::PlaylistsItemsResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl PlaylistsItemsResourceIdentifier {
    pub fn new(id: String, r#type: String) -> PlaylistsItemsResourceIdentifier {
