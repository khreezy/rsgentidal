...
#[serde(default)]
pub struct ReactionsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::ReactionsResourceObject>,
...
impl ReactionsSingleResourceDataDocument {
    pub fn new(data: models::ReactionsResourceObject, links: models::Links) -> ReactionsSingleResourceDataDocument {
