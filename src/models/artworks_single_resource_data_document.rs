...
#[serde(default)]
pub struct ArtworksSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::ArtworksResourceObject>,
...
impl ArtworksSingleResourceDataDocument {
    pub fn new(data: models::ArtworksResourceObject, links: models::Links) -> ArtworksSingleResourceDataDocument {
        ArtworksSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
