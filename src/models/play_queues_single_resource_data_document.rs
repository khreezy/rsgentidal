...
pub struct PlayQueuesSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::PlayQueuesResourceObject>,
...
impl PlayQueuesSingleResourceDataDocument {
    pub fn new(data: models::PlayQueuesResourceObject, links: models::Links) -> PlayQueuesSingleResourceDataDocument {
