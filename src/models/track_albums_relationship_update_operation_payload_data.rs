...
pub struct TrackAlbumsRelationshipUpdateOperationPayloadData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl TrackAlbumsRelationshipUpdateOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> TrackAlbumsRelationshipUpdateOperationPayloadData {
