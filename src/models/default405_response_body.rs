...
pub struct Default405ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::Default405ResponseBodyErrorsInner>,
}

impl Default405ResponseBody {
    pub fn new(errors: Vec<models::Default405ResponseBodyErrorsInner>) -> Default405ResponseBody {
