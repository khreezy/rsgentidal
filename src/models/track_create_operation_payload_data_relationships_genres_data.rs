...
pub struct TrackCreateOperationPayloadDataRelationshipsGenresData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl TrackCreateOperationPayloadDataRelationshipsGenresData {
    pub fn new(id: String, r#type: Type) -> TrackCreateOperationPayloadDataRelationshipsGenresData {
        TrackCreateOperationPayloadDataRelationshipsGenresData {
            id,
            r#type,
        }
    }
