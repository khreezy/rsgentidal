...
#[serde(default)]
pub struct StripeConnectionsMultiRelationshipDataDocument {
...
impl StripeConnectionsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> StripeConnectionsMultiRelationshipDataDocument {
