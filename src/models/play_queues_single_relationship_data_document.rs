...
pub struct PlayQueuesSingleRelationshipDataDocument {
...
impl PlayQueuesSingleRelationshipDataDocument {
    pub fn new(links: models::Links) -> PlayQueuesSingleRelationshipDataDocument {
