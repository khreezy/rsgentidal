...
#[serde(default)]
pub struct PlaylistItemsRelationshipReorderOperationPayloadMeta {
    #[serde(rename = "positionBefore")]
    pub position_before: String,
}

impl PlaylistItemsRelationshipReorderOperationPayloadMeta {
    pub fn new(position_before: String) -> PlaylistItemsRelationshipReorderOperationPayloadMeta {
        PlaylistItemsRelationshipReorderOperationPayloadMeta {
            position_before,
        }
    }
}
