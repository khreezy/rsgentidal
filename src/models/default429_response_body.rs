...
pub struct Default429ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::Default429ResponseBodyErrorsInner>,
}

impl Default429ResponseBody {
    pub fn new(errors: Vec<models::Default429ResponseBodyErrorsInner>) -> Default429ResponseBody {
