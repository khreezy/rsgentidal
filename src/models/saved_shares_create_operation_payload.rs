...
#[serde(default)]
pub struct SavedSharesCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::SavedSharesCreateOperationPayloadData>,
}

impl SavedSharesCreateOperationPayload {
    pub fn new(data: models::SavedSharesCreateOperationPayloadData) -> SavedSharesCreateOperationPayload {
