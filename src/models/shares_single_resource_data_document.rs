...
pub struct SharesSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::SharesResourceObject>,
...
impl SharesSingleResourceDataDocument {
    pub fn new(data: models::SharesResourceObject, links: models::Links) -> SharesSingleResourceDataDocument {
