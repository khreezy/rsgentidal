...
#[serde(default)]
pub struct PlayQueuesFutureResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::PlayQueuesFutureResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl PlayQueuesFutureResourceIdentifier {
    pub fn new(id: String, r#type: String) -> PlayQueuesFutureResourceIdentifier {
