...
pub struct StripeConnectionsCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::StripeConnectionsCreateOperationPayloadData>,
}

impl StripeConnectionsCreateOperationPayload {
    pub fn new(data: models::StripeConnectionsCreateOperationPayloadData) -> StripeConnectionsCreateOperationPayload {
