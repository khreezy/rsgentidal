...
pub struct VideosSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::VideosResourceObject>,
...
impl VideosSingleResourceDataDocument {
    pub fn new(data: models::VideosResourceObject, links: models::Links) -> VideosSingleResourceDataDocument {
