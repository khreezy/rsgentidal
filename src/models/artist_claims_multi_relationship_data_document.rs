...
#[serde(default)]
pub struct ArtistClaimsMultiRelationshipDataDocument {
...
impl ArtistClaimsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> ArtistClaimsMultiRelationshipDataDocument {
        ArtistClaimsMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
