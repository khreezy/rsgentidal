...
#[serde(default)]
pub struct ReactionsMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::ReactionsResourceObject>,
...
impl ReactionsMultiResourceDataDocument {
    pub fn new(data: Vec<models::ReactionsResourceObject>, links: models::Links) -> ReactionsMultiResourceDataDocument {
