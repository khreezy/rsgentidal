...
#[serde(default)]
pub struct TrackSourceFilesMultiRelationshipDataDocument {
...
impl TrackSourceFilesMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> TrackSourceFilesMultiRelationshipDataDocument {
        TrackSourceFilesMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
