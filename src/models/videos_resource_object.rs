...
#[serde(default)]
pub struct VideosResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::VideosAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::VideosRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl VideosResourceObject {
    pub fn new(id: String, r#type: String) -> VideosResourceObject {
