...
pub struct UserCollectionArtistsRelationshipAddOperationPayloadData {
    ...
    pub meta: Option<Box<models::UserCollectionArtistsRelationshipAddOperationPayloadDataMeta>>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl UserCollectionArtistsRelationshipAddOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> UserCollectionArtistsRelationshipAddOperationPayloadData {
