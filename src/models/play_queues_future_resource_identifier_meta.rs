...
pub struct PlayQueuesFutureResourceIdentifierMeta {
...
impl PlayQueuesFutureResourceIdentifierMeta {
    pub fn new(batch_id: uuid::Uuid, item_id: String) -> PlayQueuesFutureResourceIdentifierMeta {
