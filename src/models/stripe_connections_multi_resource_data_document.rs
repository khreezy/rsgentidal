...
#[serde(default)]
pub struct StripeConnectionsMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::StripeConnectionsResourceObject>,
...
impl StripeConnectionsMultiResourceDataDocument {
    pub fn new(data: Vec<models::StripeConnectionsResourceObject>, links: models::Links) -> StripeConnectionsMultiResourceDataDocument {
