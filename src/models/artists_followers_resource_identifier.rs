...
#[serde(default)]
pub struct ArtistsFollowersResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::ArtistsFollowersResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl ArtistsFollowersResourceIdentifier {
    pub fn new(id: String, r#type: String) -> ArtistsFollowersResourceIdentifier {
        ArtistsFollowersResourceIdentifier {
            id,
            meta: None,
            r#type,
        }
