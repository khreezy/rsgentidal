...
pub struct UserCollectionArtistsRelationshipAddOperationPayloadDataMeta {
    #[serde(rename = "addedAt", skip_serializing_if = "Option::is_none")]
    pub added_at: Option<String>,
}

impl UserCollectionArtistsRelationshipAddOperationPayloadDataMeta {
    pub fn new() -> UserCollectionArtistsRelationshipAddOperationPayloadDataMeta {
