...
pub struct ArtistUpdateBodyData {
    ...
    pub attributes: Box<models::ArtistUpdateBodyDataAttributes>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl ArtistUpdateBodyData {
    pub fn new(attributes: models::ArtistUpdateBodyDataAttributes, id: String, r#type: Type) -> ArtistUpdateBodyData {
