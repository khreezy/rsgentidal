...
pub struct PlayQueueAddFutureOperationPayloadData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl PlayQueueAddFutureOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> PlayQueueAddFutureOperationPayloadData {
