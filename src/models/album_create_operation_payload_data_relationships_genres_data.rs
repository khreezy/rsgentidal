...
pub struct AlbumCreateOperationPayloadDataRelationshipsGenresData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl AlbumCreateOperationPayloadDataRelationshipsGenresData {
    pub fn new(id: String, r#type: Type) -> AlbumCreateOperationPayloadDataRelationshipsGenresData {
        AlbumCreateOperationPayloadDataRelationshipsGenresData {
            id,
            r#type,
        }
    }
