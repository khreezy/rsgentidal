...
#[serde(default)]
pub struct ArtworksMultiRelationshipDataDocument {
...
impl ArtworksMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> ArtworksMultiRelationshipDataDocument {
        ArtworksMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
