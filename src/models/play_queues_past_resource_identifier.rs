...
#[serde(default)]
pub struct PlayQueuesPastResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::PlayQueuesPastResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl PlayQueuesPastResourceIdentifier {
    pub fn new(id: String, r#type: String) -> PlayQueuesPastResourceIdentifier {
