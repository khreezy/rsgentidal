...
#[serde(default)]
pub struct GenresMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::GenresResourceObject>,
...
impl GenresMultiResourceDataDocument {
    pub fn new(data: Vec<models::GenresResourceObject>, links: models::Links) -> GenresMultiResourceDataDocument {
