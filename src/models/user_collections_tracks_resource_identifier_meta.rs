...
pub struct UserCollectionsTracksResourceIdentifierMeta {
    #[serde(rename = "addedAt")]
    pub added_at: String,
}

impl UserCollectionsTracksResourceIdentifierMeta {
    pub fn new(added_at: String) -> UserCollectionsTracksResourceIdentifierMeta {
