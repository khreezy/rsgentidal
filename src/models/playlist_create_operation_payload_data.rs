...
pub struct PlaylistCreateOperationPayloadData {
    ...
    pub attributes: Box<models::PlaylistCreateOperationPayloadDataAttributes>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl PlaylistCreateOperationPayloadData {
    pub fn new(attributes: models::PlaylistCreateOperationPayloadDataAttributes, r#type: Type) -> PlaylistCreateOperationPayloadData {
