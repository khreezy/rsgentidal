...
#[serde(default)]
pub struct UserCollectionsPlaylistsMultiRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::UserCollectionsPlaylistsResourceIdentifier>>,
...
impl UserCollectionsPlaylistsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> UserCollectionsPlaylistsMultiRelationshipDataDocument {
