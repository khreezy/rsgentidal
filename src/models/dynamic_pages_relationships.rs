...
#[serde(default)]
pub struct DynamicPagesRelationships {
    #[serde(rename = "subject")]
    pub subject: Box<models::SingleRelationshipDataDocument>,
}

impl DynamicPagesRelationships {
    pub fn new(subject: models::SingleRelationshipDataDocument) -> DynamicPagesRelationships {
