...
#[serde(default)]
pub struct TrackSourceFilesResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::TrackSourceFilesAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::TrackSourceFilesRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl TrackSourceFilesResourceObject {
    pub fn new(id: String, r#type: String) -> TrackSourceFilesResourceObject {
