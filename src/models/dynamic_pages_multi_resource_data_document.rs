...
#[serde(default)]
pub struct DynamicPagesMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::DynamicPagesResourceObject>,
...
impl DynamicPagesMultiResourceDataDocument {
    pub fn new(data: Vec<models::DynamicPagesResourceObject>, links: models::Links) -> DynamicPagesMultiResourceDataDocument {
