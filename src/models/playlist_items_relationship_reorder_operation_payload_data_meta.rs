...
#[serde(default)]
pub struct PlaylistItemsRelationshipReorderOperationPayloadDataMeta {
    #[serde(rename = "itemId")]
    pub item_id: String,
}

impl PlaylistItemsRelationshipReorderOperationPayloadDataMeta {
    pub fn new(item_id: String) -> PlaylistItemsRelationshipReorderOperationPayloadDataMeta {
        PlaylistItemsRelationshipReorderOperationPayloadDataMeta {
            item_id,
        }
    }
}
