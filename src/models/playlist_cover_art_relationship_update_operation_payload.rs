...
pub struct PlaylistCoverArtRelationshipUpdateOperationPayload {
    #[serde(rename = "data")]
    pub data: Vec<models::PlaylistCoverArtRelationshipUpdateOperationPayloadData>,
}

impl PlaylistCoverArtRelationshipUpdateOperationPayload {
    pub fn new(data: Vec<models::PlaylistCoverArtRelationshipUpdateOperationPayloadData>) -> PlaylistCoverArtRelationshipUpdateOperationPayload {
