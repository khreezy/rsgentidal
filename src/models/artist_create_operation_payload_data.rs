...
pub struct ArtistCreateOperationPayloadData {
    #[serde(rename = "attributes")]
    pub attributes: Box<models::ArtistCreateOperationPayloadDataAttributes>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl ArtistCreateOperationPayloadData {
    pub fn new(attributes: models::ArtistCreateOperationPayloadDataAttributes, r#type: Type) -> ArtistCreateOperationPayloadData {
        ArtistCreateOperationPayloadData {
