...
pub struct UserCollectionFoldersSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::UserCollectionFoldersResourceObject>,
...
impl UserCollectionFoldersSingleResourceDataDocument {
    pub fn new(data: models::UserCollectionFoldersResourceObject, links: models::Links) -> UserCollectionFoldersSingleResourceDataDocument {
