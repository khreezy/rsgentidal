...
#[serde(default)]
pub struct ArtistRolesMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::ArtistRolesResourceObject>,
...
impl ArtistRolesMultiResourceDataDocument {
    pub fn new(data: Vec<models::ArtistRolesResourceObject>, links: models::Links) -> ArtistRolesMultiResourceDataDocument {
        ArtistRolesMultiResourceDataDocument {
            data,
            included: None,
            links: Box::new(links),
        }
