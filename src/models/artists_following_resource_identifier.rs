...
#[serde(default)]
pub struct ArtistsFollowingResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::ArtistsFollowingResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl ArtistsFollowingResourceIdentifier {
    pub fn new(id: String, r#type: String) -> ArtistsFollowingResourceIdentifier {
        ArtistsFollowingResourceIdentifier {
            id,
            meta: None,
            r#type,
        }
