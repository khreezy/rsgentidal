...
pub struct PlayQueuesMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::PlayQueuesResourceObject>,
...
impl PlayQueuesMultiResourceDataDocument {
    pub fn new(data: Vec<models::PlayQueuesResourceObject>, links: models::Links) -> PlayQueuesMultiResourceDataDocument {
