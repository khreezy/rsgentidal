...
#[serde(default)]
pub struct ArtistsMultiRelationshipDataDocument {
...
impl ArtistsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> ArtistsMultiRelationshipDataDocument {
        ArtistsMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
