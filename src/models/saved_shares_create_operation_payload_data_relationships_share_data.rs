...
#[serde(default)]
pub struct SavedSharesCreateOperationPayloadDataRelationshipsShareData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl SavedSharesCreateOperationPayloadDataRelationshipsShareData {
    pub fn new(id: String, r#type: Type) -> SavedSharesCreateOperationPayloadDataRelationshipsShareData {
