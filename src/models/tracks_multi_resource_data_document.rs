...
#[serde(default)]
pub struct TracksMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::TracksResourceObject>,
...
impl TracksMultiResourceDataDocument {
    pub fn new(data: Vec<models::TracksResourceObject>, links: models::Links) -> TracksMultiResourceDataDocument {
