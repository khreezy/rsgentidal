...
pub struct LyricsUpdateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::LyricsUpdateOperationPayloadData>,
}

impl LyricsUpdateOperationPayload {
    pub fn new(data: models::LyricsUpdateOperationPayloadData) -> LyricsUpdateOperationPayload {
        LyricsUpdateOperationPayload {
            data: Box::new(data),
        }
    }
}
