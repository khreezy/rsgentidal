...
#[serde(default)]
pub struct ReactionsResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::ReactionsAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::ReactionsRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl ReactionsResourceObject {
    pub fn new(id: String, r#type: String) -> ReactionsResourceObject {
        ReactionsResourceObject {
            attributes: None,
            id,
            relationships: None,
            r#type,
