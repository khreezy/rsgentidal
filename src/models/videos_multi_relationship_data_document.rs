...
pub struct VideosMultiRelationshipDataDocument {
...
impl VideosMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> VideosMultiRelationshipDataDocument {
        VideosMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
