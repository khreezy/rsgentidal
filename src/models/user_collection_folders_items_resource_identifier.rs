...
#[serde(default)]
pub struct UserCollectionFoldersItemsResourceIdentifier {
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<models::UserCollectionFoldersItemsResourceIdentifierMeta>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl UserCollectionFoldersItemsResourceIdentifier {
    pub fn new(id: String, r#type: String) -> UserCollectionFoldersItemsResourceIdentifier {
