...
#[serde(default)]
pub struct TrackManifestsReadById403ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::TrackFilesReadById403ResponseBodyErrorsInner>,
}

impl TrackManifestsReadById403ResponseBody {
    pub fn new(errors: Vec<models::TrackFilesReadById403ResponseBodyErrorsInner>) -> TrackManifestsReadById403ResponseBody {
