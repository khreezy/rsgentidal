...
pub struct ArtistFollowingRelationshipRemoveOperationPayloadData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl ArtistFollowingRelationshipRemoveOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> ArtistFollowingRelationshipRemoveOperationPayloadData {
        ArtistFollowingRelationshipRemoveOperationPayloadData {
            id,
            r#type,
        }
    }
