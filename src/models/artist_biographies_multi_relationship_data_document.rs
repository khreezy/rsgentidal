...
#[serde(default)]
pub struct ArtistBiographiesMultiRelationshipDataDocument {
...
impl ArtistBiographiesMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> ArtistBiographiesMultiRelationshipDataDocument {
        ArtistBiographiesMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
