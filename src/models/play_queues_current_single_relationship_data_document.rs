...
pub struct PlayQueuesCurrentSingleRelationshipDataDocument {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PlayQueuesCurrentResourceIdentifier>>,
...
impl PlayQueuesCurrentSingleRelationshipDataDocument {
    pub fn new(links: models::Links) -> PlayQueuesCurrentSingleRelationshipDataDocument {
