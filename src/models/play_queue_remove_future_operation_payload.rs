...
#[serde(default)]
pub struct PlayQueueRemoveFutureOperationPayload {
    #[serde(rename = "data")]
    pub data: Vec<models::PlayQueueRemoveFutureOperationPayloadData>,
}

impl PlayQueueRemoveFutureOperationPayload {
    pub fn new(data: Vec<models::PlayQueueRemoveFutureOperationPayloadData>) -> PlayQueueRemoveFutureOperationPayload {
