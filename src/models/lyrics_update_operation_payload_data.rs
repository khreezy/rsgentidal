...
#[serde(default)]
pub struct LyricsUpdateOperationPayloadData {
    #[serde(rename = "attributes")]
    pub attributes: Box<models::LyricsUpdateOperationPayloadDataAttributes>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl LyricsUpdateOperationPayloadData {
    pub fn new(attributes: models::LyricsUpdateOperationPayloadDataAttributes, id: String, r#type: Type) -> LyricsUpdateOperationPayloadData {
        LyricsUpdateOperationPayloadData {
