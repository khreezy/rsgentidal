...
#[serde(default)]
pub struct PlaylistsMultiRelationshipDataDocument {
...
impl PlaylistsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> PlaylistsMultiRelationshipDataDocument {
        PlaylistsMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
