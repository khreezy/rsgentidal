...
pub struct PlaylistsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::PlaylistsResourceObject>,
...
impl PlaylistsSingleResourceDataDocument {
    pub fn new(data: models::PlaylistsResourceObject, links: models::Links) -> PlaylistsSingleResourceDataDocument {
        PlaylistsSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
