...
#[serde(default)]
pub struct UserCollectionArtistsRelationshipRemoveOperationPayloadData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl UserCollectionArtistsRelationshipRemoveOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> UserCollectionArtistsRelationshipRemoveOperationPayloadData {
        UserCollectionArtistsRelationshipRemoveOperationPayloadData {
            id,
            r#type,
        }
    }
