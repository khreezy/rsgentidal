...
pub struct UserCollectionsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::UserCollectionsResourceObject>,
...
impl UserCollectionsSingleResourceDataDocument {
    pub fn new(data: models::UserCollectionsResourceObject, links: models::Links) -> UserCollectionsSingleResourceDataDocument {
        UserCollectionsSingleResourceDataDocument {
            data: Box::new(data),
            included: None,
            links: Box::new(links),
        }
