...
pub struct UserCollectionsPlaylistsResourceIdentifierMeta {
    #[serde(rename = "addedAt")]
    pub added_at: String,
}

impl UserCollectionsPlaylistsResourceIdentifierMeta {
    pub fn new(added_at: String) -> UserCollectionsPlaylistsResourceIdentifierMeta {
        UserCollectionsPlaylistsResourceIdentifierMeta {
            added_at,
        }
    }
}
