...
pub struct VideosSingleRelationshipDataDocument {
...
impl VideosSingleRelationshipDataDocument {
    pub fn new(links: models::Links) -> VideosSingleRelationshipDataDocument {
