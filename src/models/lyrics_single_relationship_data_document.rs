...
pub struct LyricsSingleRelationshipDataDocument {
...
impl LyricsSingleRelationshipDataDocument {
    pub fn new(links: models::Links) -> LyricsSingleRelationshipDataDocument {
        LyricsSingleRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
