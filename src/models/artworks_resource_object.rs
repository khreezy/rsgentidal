...
#[serde(default)]
pub struct ArtworksResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::ArtworksAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::ArtworksRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl ArtworksResourceObject {
    pub fn new(id: String, r#type: String) -> ArtworksResourceObject {
