...
pub struct LyricsRelationships {
    ...
    #[serde(rename = "track")]
    pub track: Box<models::SingleRelationshipDataDocument>,
}

impl LyricsRelationships {
    pub fn new(owners: models::MultiRelationshipDataDocument, track: models::SingleRelationshipDataDocument) -> LyricsRelationships {
        LyricsRelationships {
