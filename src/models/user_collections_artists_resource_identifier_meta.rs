...
pub struct UserCollectionsArtistsResourceIdentifierMeta {
    #[serde(rename = "addedAt")]
    pub added_at: String,
}

impl UserCollectionsArtistsResourceIdentifierMeta {
    pub fn new(added_at: String) -> UserCollectionsArtistsResourceIdentifierMeta {
        UserCollectionsArtistsResourceIdentifierMeta {
            added_at,
        }
    }
}
