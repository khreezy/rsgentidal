...
#[serde(default)]
pub struct UserCollectionFoldersRelationships {
    #[serde(rename = "items")]
    pub items: Box<models::UserCollectionFoldersItemsMultiRelationshipDataDocument>,
    #[serde(rename = "owners")]
    pub owners: Box<models::MultiRelationshipDataDocument>,
}

impl UserCollectionFoldersRelationships {
    pub fn new(items: models::UserCollectionFoldersItemsMultiRelationshipDataDocument, owners: models::MultiRelationshipDataDocument) -> UserCollectionFoldersRelationships {
        UserCollectionFoldersRelationships {
            items: Box::new(items),
