...
pub struct Default404ResponseBody {
    #[serde(rename = "errors")]
    pub errors: Vec<models::Default404ResponseBodyErrorsInner>,
}

impl Default404ResponseBody {
    pub fn new(errors: Vec<models::Default404ResponseBodyErrorsInner>) -> Default404ResponseBody {
