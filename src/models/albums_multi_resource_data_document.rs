...
pub struct AlbumsMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::AlbumsResourceObject>,
...
impl AlbumsMultiResourceDataDocument {
    pub fn new(data: Vec<models::AlbumsResourceObject>, links: models::Links) -> AlbumsMultiResourceDataDocument {
        AlbumsMultiResourceDataDocument {
            data,
            included: None,
            links: Box::new(links),
        }
