...
pub struct UserEntitlementsRelationships {
    #[serde(rename = "owners")]
    pub owners: Box<models::MultiRelationshipDataDocument>,
}

impl UserEntitlementsRelationships {
    pub fn new(owners: models::MultiRelationshipDataDocument) -> UserEntitlementsRelationships {
