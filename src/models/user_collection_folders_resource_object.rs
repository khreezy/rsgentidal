...
#[serde(default)]
pub struct UserCollectionFoldersResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::UserCollectionFoldersAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::UserCollectionFoldersRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl UserCollectionFoldersResourceObject {
    pub fn new(id: String, r#type: String) -> UserCollectionFoldersResourceObject {
