...
pub struct LyricsMultiRelationshipDataDocument {
...
impl LyricsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> LyricsMultiRelationshipDataDocument {
        LyricsMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
