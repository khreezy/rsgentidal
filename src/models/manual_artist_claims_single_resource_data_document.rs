...
pub struct ManualArtistClaimsSingleResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Box<models::ManualArtistClaimsResourceObject>,
...
impl ManualArtistClaimsSingleResourceDataDocument {
    pub fn new(data: models::ManualArtistClaimsResourceObject, links: models::Links) -> ManualArtistClaimsSingleResourceDataDocument {
