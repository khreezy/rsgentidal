...
pub struct SharesMultiRelationshipDataDocument {
...
impl SharesMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> SharesMultiRelationshipDataDocument {
