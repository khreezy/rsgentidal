...
#[serde(default)]
pub struct PlayQueueUpdateFutureOperationPayloadDataMeta {
    #[serde(rename = "itemId")]
    pub item_id: String,
}

impl PlayQueueUpdateFutureOperationPayloadDataMeta {
    pub fn new(item_id: String) -> PlayQueueUpdateFutureOperationPayloadDataMeta {
