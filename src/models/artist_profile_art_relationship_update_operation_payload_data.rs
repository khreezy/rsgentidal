...
#[serde(default)]
pub struct ArtistProfileArtRelationshipUpdateOperationPayloadData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl ArtistProfileArtRelationshipUpdateOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> ArtistProfileArtRelationshipUpdateOperationPayloadData {
        ArtistProfileArtRelationshipUpdateOperationPayloadData {
            id,
            r#type,
        }
    }
