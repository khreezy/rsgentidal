...
pub struct PlayQueuesResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::PlayQueuesAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::PlayQueuesRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl PlayQueuesResourceObject {
    pub fn new(id: String, r#type: String) -> PlayQueuesResourceObject {
