...
#[serde(default)]
pub struct ArtistClaimsCreateOperationPayloadMeta {
...
impl ArtistClaimsCreateOperationPayloadMeta {
    pub fn new(redirect_url: String) -> ArtistClaimsCreateOperationPayloadMeta {
