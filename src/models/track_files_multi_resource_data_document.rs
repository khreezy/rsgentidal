...
#[serde(default)]
pub struct TrackFilesMultiResourceDataDocument {
    #[serde(rename = "data")]
    pub data: Vec<models::TrackFilesResourceObject>,
...
impl TrackFilesMultiResourceDataDocument {
    pub fn new(data: Vec<models::TrackFilesResourceObject>, links: models::Links) -> TrackFilesMultiResourceDataDocument {
        TrackFilesMultiResourceDataDocument {
            data,
            included: None,
            links: Box::new(links),
        }
