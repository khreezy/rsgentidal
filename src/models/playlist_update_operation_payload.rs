...
pub struct PlaylistUpdateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::PlaylistUpdateOperationPayloadData>,
}

impl PlaylistUpdateOperationPayload {
    pub fn new(data: models::PlaylistUpdateOperationPayloadData) -> PlaylistUpdateOperationPayload {
        PlaylistUpdateOperationPayload {
            data: Box::new(data),
        }
    }
}
