...
pub struct TrackCreateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::TrackCreateOperationPayloadData>,
}

impl TrackCreateOperationPayload {
    pub fn new(data: models::TrackCreateOperationPayloadData) -> TrackCreateOperationPayload {
        TrackCreateOperationPayload {
            data: Box::new(data),
        }
    }
}
