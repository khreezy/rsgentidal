...
pub struct PlaylistCoverArtRelationshipUpdateOperationPayloadData {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl PlaylistCoverArtRelationshipUpdateOperationPayloadData {
    pub fn new(id: String, r#type: Type) -> PlaylistCoverArtRelationshipUpdateOperationPayloadData {
        PlaylistCoverArtRelationshipUpdateOperationPayloadData {
            id,
            r#type,
        }
    }
