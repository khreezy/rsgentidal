...
#[serde(default)]
pub struct TrackUpdateOperationPayload {
    #[serde(rename = "data")]
    pub data: Box<models::TrackUpdateOperationPayloadData>,
}

impl TrackUpdateOperationPayload {
    pub fn new(data: models::TrackUpdateOperationPayloadData) -> TrackUpdateOperationPayload {
        TrackUpdateOperationPayload {
            data: Box::new(data),
        }
    }
}
