...
#[serde(default)]
pub struct TrackStatisticsMultiRelationshipDataDocument {
...
impl TrackStatisticsMultiRelationshipDataDocument {
    pub fn new(links: models::Links) -> TrackStatisticsMultiRelationshipDataDocument {
        TrackStatisticsMultiRelationshipDataDocument {
            data: None,
            included: None,
            links: Box::new(links),
        }
