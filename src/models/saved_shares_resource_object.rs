...
pub struct SavedSharesResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::SavedSharesAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    /// Resource type
...
impl SavedSharesResourceObject {
    pub fn new(id: String, r#type: String) -> SavedSharesResourceObject {
