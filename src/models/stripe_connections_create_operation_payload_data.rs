...
pub struct StripeConnectionsCreateOperationPayloadData {
    #[serde(rename = "attributes")]
    pub attributes: Box<models::StripeConnectionsCreateOperationPayloadDataAttributes>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl StripeConnectionsCreateOperationPayloadData {
    pub fn new(attributes: models::StripeConnectionsCreateOperationPayloadDataAttributes, r#type: Type) -> StripeConnectionsCreateOperationPayloadData {
