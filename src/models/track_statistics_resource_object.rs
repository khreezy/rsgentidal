...
#[serde(default)]
pub struct TrackStatisticsResourceObject {
    #[serde(rename = "attributes", skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Box<models::TrackStatisticsAttributes>>,
    /// Resource id
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "relationships", skip_serializing_if = "Option::is_none")]
    pub relationships: Option<Box<models::TrackStatisticsRelationships>>,
    /// Resource type
    #[serde(rename = "type")]
    pub r#type: String,
}

impl TrackStatisticsResourceObject {
    pub fn new(id: String, r#type: String) -> TrackStatisticsResourceObject {
