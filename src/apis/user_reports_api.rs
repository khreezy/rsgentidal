...
pub trait UserReportsApi: Send + Sync {
    ...
    async fn create_user_report<'user_report_create_operation_payload>(
        &self,
        user_report_create_operation_payload: Option<models::UserReportCreateOperationPayload>,
    ) -> Result<models::UserReportsSingleResourceDataDocument, Error<CreateUserReportError>>;
}
...
impl UserReportsApi for UserReportsApiClient {
    ...
    async fn create_user_report<'user_report_create_operation_payload>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateUserReportError> =
