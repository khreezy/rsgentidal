...
pub trait AppreciationsApi: Send + Sync {
    ...
    async fn create_appreciation<'appreciations_create_operation_payload>(&self, appreciations_create_operation_payload: Option<models::AppreciationsCreateOperationPayload>) -> Result<models::AppreciationsSingleResourceDataDocument, Error<CreateAppreciationError>>;
}
...
impl AppreciationsApi for AppreciationsApiClient {
    ...
    async fn create_appreciation<'appreciations_create_operation_payload>(&self, appreciations_create_operation_payload: Option<models::AppreciationsCreateOperationPayload>) -> Result<models::AppreciationsSingleResourceDataDocument, Error<CreateAppreciationError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateAppreciationError> = serde_json::from_str(&local_var_content).ok();
