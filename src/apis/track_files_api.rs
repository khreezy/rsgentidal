...
pub trait TrackFilesApi: Send + Sync {
    ...
    async fn get_track_file<'id, 'formats, 'usage>(
        &self,
        id: &'id str,
        formats: Vec<String>,
        usage: &'usage str,
    ) -> Result<models::TrackFilesSingleResourceDataDocument, Error<GetTrackFileError>>;
}
...
impl TrackFilesApi for TrackFilesApiClient {
    ...
    async fn get_track_file<'id, 'formats, 'usage>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetTrackFileError> =
