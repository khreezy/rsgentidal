...
pub trait UserEntitlementsApi: Send + Sync {
    ...
    async fn get_user_entitlement<'id, 'include>(
        &self,
        id: &'id str,
        include: Option<Vec<String>>,
    ) -> Result<models::UserEntitlementsSingleResourceDataDocument, Error<GetUserEntitlementError>>;
...
impl UserEntitlementsApi for UserEntitlementsApiClient {
    ...
    ) -> Result<models::UserEntitlementsSingleResourceDataDocument, Error<GetUserEntitlementError>>
    {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetUserEntitlementError> =
    ...
    > {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetUserEntitlementOwnersError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
