...
pub trait ProvidersApi: Send + Sync {
    ...
    async fn get_provider<'id>(&self, id: &'id str) -> Result<models::ProvidersSingleResourceDataDocument, Error<GetProviderError>>;

    /// GET /providers
    ///
    /// Retrieves multiple providers by available filters, or without if applicable.
    async fn get_providers<'filter_left_square_bracket_id_right_square_bracket>(&self, filter_left_square_bracket_id_right_square_bracket: Option<Vec<String>>) -> Result<models::ProvidersMultiResourceDataDocument, Error<GetProvidersError>>;
}
...
impl ProvidersApi for ProvidersApiClient {
    ...
    async fn get_provider<'id>(&self, id: &'id str) -> Result<models::ProvidersSingleResourceDataDocument, Error<GetProviderError>> {
        ...
        let local_var_uri_str = format!("{}/providers/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ProvidersSingleResourceDataDocument`")))),
            }
        } else {
    ...
    async fn get_providers<'filter_left_square_bracket_id_right_square_bracket>(&self, filter_left_square_bracket_id_right_square_bracket: Option<Vec<String>>) -> Result<models::ProvidersMultiResourceDataDocument, Error<GetProvidersError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ProvidersMultiResourceDataDocument`")))),
            }
        } else {
...
/// struct for typed errors of method [`ProvidersApi::get_provider`]
...
/// struct for typed errors of method [`ProvidersApi::get_providers`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
