...
pub trait UserRecommendationsApi: Send + Sync {
    ...
    async fn get_user_recommendation<'id, 'country_code, 'locale, 'include>(
        &self,
        id: &'id str,
        ...
        Error<GetUserRecommendationError>,
    >;
    ...
    >(
        ...
        models::UserRecommendationsMultiRelationshipDataDocument,
        Error<GetUserRecommendationDiscoveryMixesError>,
    >;
    ...
    >(
        ...
        models::UserRecommendationsMultiRelationshipDataDocument,
        Error<GetUserRecommendationMyMixesError>,
    >;
    ...
    >(
        ...
        models::UserRecommendationsMultiRelationshipDataDocument,
        Error<GetUserRecommendationNewArrivalMixesError>,
    >;
}
...
impl UserRecommendationsApi for UserRecommendationsApiClient {
    ...
    > {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetUserRecommendationError> =
    ...
    > {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetUserRecommendationDiscoveryMixesError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    > {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetUserRecommendationMyMixesError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    > {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetUserRecommendationNewArrivalMixesError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
