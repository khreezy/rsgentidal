...
pub trait SearchSuggestionsApi: Send + Sync {
    ...
    async fn get_search_suggestion<'id, 'explicit_filter, 'country_code, 'include>(&self, id: &'id str, explicit_filter: Option<&'explicit_filter str>, country_code: Option<&'country_code str>, include: Option<Vec<String>>) -> Result<models::SearchSuggestionsSingleResourceDataDocument, Error<GetSearchSuggestionError>>;

    /// GET /searchSuggestions/{id}/relationships/directHits
    ///
    /// Retrieves directHits relationship.
    async fn get_search_suggestion_direct_hits<'id, 'explicit_filter, 'country_code, 'include, 'page_left_square_bracket_cursor_right_square_bracket>(&self, id: &'id str, explicit_filter: Option<&'explicit_filter str>, country_code: Option<&'country_code str>, include: Option<Vec<String>>, page_left_square_bracket_cursor_right_square_bracket: Option<&'page_left_square_bracket_cursor_right_square_bracket str>) -> Result<models::SearchSuggestionsMultiRelationshipDataDocument, Error<GetSearchSuggestionDirectHitsError>>;
}
...
impl SearchSuggestionsApi for SearchSuggestionsApiClient {
    ...
    async fn get_search_suggestion<'id, 'explicit_filter, 'country_code, 'include>(&self, id: &'id str, explicit_filter: Option<&'explicit_filter str>, country_code: Option<&'country_code str>, include: Option<Vec<String>>) -> Result<models::SearchSuggestionsSingleResourceDataDocument, Error<GetSearchSuggestionError>> {
        ...
        let local_var_uri_str = format!("{}/searchSuggestions/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetSearchSuggestionError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_search_suggestion_direct_hits<'id, 'explicit_filter, 'country_code, 'include, 'page_left_square_bracket_cursor_right_square_bracket>(&self, id: &'id str, explicit_filter: Option<&'explicit_filter str>, country_code: Option<&'country_code str>, include: Option<Vec<String>>, page_left_square_bracket_cursor_right_square_bracket: Option<&'page_left_square_bracket_cursor_right_square_bracket str>) -> Result<models::SearchSuggestionsMultiRelationshipDataDocument, Error<GetSearchSuggestionDirectHitsError>> {
        ...
        let local_var_uri_str = format!("{}/searchSuggestions/{id}/relationships/directHits", local_var_configuration.base_path, id=crate::apis::urlencode(id));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetSearchSuggestionDirectHitsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
